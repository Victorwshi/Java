...
class GUI extends TopLevel implements View, Reporter {
    ...
    GUI(String title) {
        ...
        addMenuButton("Menu->Quit", this::quit);
        addMenuButton("Menu->new", this::doNew);
        addMenuButton("Settings->manual black", this::manualBlack);
        addMenuButton("Settings->nanual white", this::manualWhite);
    ...
    /** autoBlack.
     * @param black string is taken  */
    private void autoBlack(String black) {
        _pendingCommands.offer("auto black");
    }
    /** autoWhite.
     * @param white string is taken */
    private void autoWhite(String white) {
        _pendingCommands.offer("auto white");
    }
    /** manBlack.
     * @param mBlack string is taken */
    private void manualBlack(String mBlack) {
        _pendingCommands.offer("manual black");
    }
    /** manWhite.
     * @param mWhite string is taken */
    private void manualWhite(String mWhite) {
        _pendingCommands.offer("manual white");
    }
    /** doNew.
     * @param doNew string is taken  */
    private void doNew(String doNew) {
