...
class BoardWidget extends Pad {
    ...
    private void drawGrid(Graphics2D g) {
        ...
        g.fillRect(cx(Board.THRONE) + PIX, cy(Board.THRONE),
                SQUARE_SIDE, SQUARE_SIDE);
        g.fillRect(cx(Board.THRONE) - PIX, cy(Board.THRONE),
                SQUARE_SIDE, SQUARE_SIDE);
        g.fillRect(cx(Board.THRONE), cy(Board.THRONE) + PIX,
                SQUARE_SIDE, SQUARE_SIDE);
        g.fillRect(cx(Board.THRONE), cy(Board.THRONE) - PIX,
                SQUARE_SIDE, SQUARE_SIDE);
        g.fillRect(cx(Board.THRONE) + PIX, cy(Board.THRONE) + PIX,
                SQUARE_SIDE, SQUARE_SIDE);
        g.fillRect(cx(Board.THRONE) + PIX, cy(Board.THRONE) - PIX,
                SQUARE_SIDE, SQUARE_SIDE);
        g.fillRect(cx(Board.THRONE) - PIX, cy(Board.THRONE) + PIX,
    ...
    private void drawPiece(Graphics2D g, Square s) {
        ...
        if (s.equals(checkSquare)) {
            g.setColor(CLICKED_SQUARE_COLOR);
            g.fillRect(cx(s), cy(s), PIX, PIX);
        }
        if (_board.get(s) == BLACK) {
            g.setColor(BLACK_COLOR);
            g.fillOval(cx(s), cy(s), PIX, PIX);
    ...
    private void click(Square s) {
        ...
        if (checkSquare != null) {
            if (_board.isLegal(s)
                    && _board.isLegal(checkSquare, s)) {
                _board.makeMove(checkSquare, s);
                update(_board);
                checkSquare = null;
            } else {
                checkSquare = null;
    ...
    /** A square location that checks s. */
